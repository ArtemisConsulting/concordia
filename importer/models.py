...
class CollectionTaskDetails(models.Model):
    ...
    collection_thumbnail = models.ImageField(upload_to='thumbnails/collections/', blank=True, null=True)
    project_thumbnail = models.ImageField(upload_to='thumbnails/projects/', blank=True, null=True)
